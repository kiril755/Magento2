...
class Interceptor extends \Magento\Review\Model\ResourceModel\Rating\Option\Vote\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setReviewFilter');
        return $pluginInfo ? $this->___callPlugins('setReviewFilter', func_get_args(), $pluginInfo) : parent::setReviewFilter($reviewId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setEntityPkFilter');
        return $pluginInfo ? $this->___callPlugins('setEntityPkFilter', func_get_args(), $pluginInfo) : parent::setEntityPkFilter($entityId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addRatingInfo');
        return $pluginInfo ? $this->___callPlugins('addRatingInfo', func_get_args(), $pluginInfo) : parent::addRatingInfo($storeId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addOptionInfo');
        return $pluginInfo ? $this->___callPlugins('addOptionInfo', func_get_args(), $pluginInfo) : parent::addOptionInfo();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addRatingOptions');
        return $pluginInfo ? $this->___callPlugins('addRatingOptions', func_get_args(), $pluginInfo) : parent::addRatingOptions();
    }
