...
class Interceptor extends \Magento\Review\Model\ResourceModel\Rating\Option\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addRatingFilter');
        return $pluginInfo ? $this->___callPlugins('addRatingFilter', func_get_args(), $pluginInfo) : parent::addRatingFilter($rating);
    }
