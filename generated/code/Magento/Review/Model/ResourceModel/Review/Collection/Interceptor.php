...
class Interceptor extends \Magento\Review\Model\ResourceModel\Review\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addEntityFilter($entity, $pkValue)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addEntityFilter', func_get_args(), $pluginInfo) : parent::addEntityFilter($entity, $pkValue);
    }
    ...
    public function addReviewsTotalCount()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addReviewsTotalCount', func_get_args(), $pluginInfo) : parent::addReviewsTotalCount();
    }
