...
class Interceptor extends \Magento\Checkout\CustomerData\Cart implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isGuestCheckoutAllowed');
        return $pluginInfo ? $this->___callPlugins('isGuestCheckoutAllowed', func_get_args(), $pluginInfo) : parent::isGuestCheckoutAllowed();
    }
