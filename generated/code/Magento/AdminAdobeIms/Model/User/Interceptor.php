...
class Interceptor extends \Magento\AdminAdobeIms\Model\User implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function loadByEmail(string $email) : array
    {
        ...
        return $pluginInfo ? $this->___callPlugins('loadByEmail', func_get_args(), $pluginInfo) : parent::loadByEmail($email);
    }

    /**
     * {@inheritdoc}
     */
    public function loginByUsername($username) : \Magento\AdminAdobeIms\Model\User
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'loginByUsername');
        return $pluginInfo ? $this->___callPlugins('loginByUsername', func_get_args(), $pluginInfo) : parent::loginByUsername($username);
    }
