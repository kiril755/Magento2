...
class Interceptor extends \Magento\Security\Model\ResourceModel\PasswordResetRequestEvent\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'filterByAccountReference');
        return $pluginInfo ? $this->___callPlugins('filterByAccountReference', func_get_args(), $pluginInfo) : parent::filterByAccountReference($reference);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'filterByIp');
        return $pluginInfo ? $this->___callPlugins('filterByIp', func_get_args(), $pluginInfo) : parent::filterByIp($ip);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'filterByRequestType');
        return $pluginInfo ? $this->___callPlugins('filterByRequestType', func_get_args(), $pluginInfo) : parent::filterByRequestType($requestType);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'filterByLifetime');
        return $pluginInfo ? $this->___callPlugins('filterByLifetime', func_get_args(), $pluginInfo) : parent::filterByLifetime($lifetime);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'filterLastItem');
        return $pluginInfo ? $this->___callPlugins('filterLastItem', func_get_args(), $pluginInfo) : parent::filterLastItem();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'filterByIpOrAccountReference');
        return $pluginInfo ? $this->___callPlugins('filterByIpOrAccountReference', func_get_args(), $pluginInfo) : parent::filterByIpOrAccountReference($ip, $accountReference);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'deleteRecordsOlderThen');
        return $pluginInfo ? $this->___callPlugins('deleteRecordsOlderThen', func_get_args(), $pluginInfo) : parent::deleteRecordsOlderThen($timestamp);
    }
