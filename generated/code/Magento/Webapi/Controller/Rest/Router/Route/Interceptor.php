...
class Interceptor extends \Magento\Webapi\Controller\Rest\Router\Route implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getInputArraySizeLimit');
        return $pluginInfo ? $this->___callPlugins('getInputArraySizeLimit', func_get_args(), $pluginInfo) : parent::getInputArraySizeLimit();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setInputArraySizeLimit');
        $pluginInfo ? $this->___callPlugins('setInputArraySizeLimit', func_get_args(), $pluginInfo) : parent::setInputArraySizeLimit($limit);
    }
}
