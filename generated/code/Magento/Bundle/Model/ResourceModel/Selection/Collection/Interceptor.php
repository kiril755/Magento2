...
class Interceptor extends \Magento\Bundle\Model\ResourceModel\Selection\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function _afterLoad()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('_afterLoad', func_get_args(), $pluginInfo) : parent::_afterLoad();
    }
    ...
    public function joinPrices($websiteId)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('joinPrices', func_get_args(), $pluginInfo) : parent::joinPrices($websiteId);
    }
    ...
    public function setOptionIdsFilter($optionIds)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setOptionIdsFilter', func_get_args(), $pluginInfo) : parent::setOptionIdsFilter($optionIds);
    }
    ...
    public function setSelectionIdsFilter($selectionIds)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setSelectionIdsFilter', func_get_args(), $pluginInfo) : parent::setSelectionIdsFilter($selectionIds);
    }
    ...
    public function addPriceFilter($product, $searchMin, $useRegularPrice = false)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addPriceFilter', func_get_args(), $pluginInfo) : parent::addPriceFilter($product, $searchMin, $useRegularPrice);
    }
