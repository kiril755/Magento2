...
class Interceptor extends \Magento\Bundle\Model\ResourceModel\Option\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinValues');
        return $pluginInfo ? $this->___callPlugins('joinValues', func_get_args(), $pluginInfo) : parent::joinValues($storeId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setProductIdFilter');
        return $pluginInfo ? $this->___callPlugins('setProductIdFilter', func_get_args(), $pluginInfo) : parent::setProductIdFilter($productId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setProductLinkFilter');
        return $pluginInfo ? $this->___callPlugins('setProductLinkFilter', func_get_args(), $pluginInfo) : parent::setProductLinkFilter($productLinkFieldValue);
    }
    ...
    public function setPositionOrder()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setPositionOrder', func_get_args(), $pluginInfo) : parent::setPositionOrder();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'appendSelections');
        return $pluginInfo ? $this->___callPlugins('appendSelections', func_get_args(), $pluginInfo) : parent::appendSelections($selectionsCollection, $stripBefore, $appendAll);
    }
    ...
    public function setIdFilter($ids)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setIdFilter', func_get_args(), $pluginInfo) : parent::setIdFilter($ids);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'resetAllIds');
        return $pluginInfo ? $this->___callPlugins('resetAllIds', func_get_args(), $pluginInfo) : parent::resetAllIds();
    }
