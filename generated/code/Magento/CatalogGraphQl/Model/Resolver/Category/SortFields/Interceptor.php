...
class Interceptor extends \Magento\CatalogGraphQl\Model\Resolver\Category\SortFields implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Catalog\Model\Config $catalogConfig, \Magento\Catalog\Model\Category\Attribute\Source\Sortby $sortbyAttributeSource)
    {
        $this->___init();
        parent::__construct($catalogConfig, $sortbyAttributeSource);
    }
