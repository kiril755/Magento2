...
class Interceptor extends \Magento\Quote\Model\ResourceModel\Quote\Item\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function resetJoinQuotes($quotesTableName, $productId = null) : \Magento\Quote\Model\ResourceModel\Quote\Item\Collection
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'resetJoinQuotes');
        return $pluginInfo ? $this->___callPlugins('resetJoinQuotes', func_get_args(), $pluginInfo) : parent::resetJoinQuotes($quotesTableName, $productId);
    }
