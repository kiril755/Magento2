...
class Interceptor extends \Magento\Tax\Model\ResourceModel\Calculation\Rule\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinCalculationData');
        return $pluginInfo ? $this->___callPlugins('joinCalculationData', func_get_args(), $pluginInfo) : parent::joinCalculationData($alias);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addProductTaxClassesToResult');
        return $pluginInfo ? $this->___callPlugins('addProductTaxClassesToResult', func_get_args(), $pluginInfo) : parent::addProductTaxClassesToResult();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addCustomerTaxClassesToResult');
        return $pluginInfo ? $this->___callPlugins('addCustomerTaxClassesToResult', func_get_args(), $pluginInfo) : parent::addCustomerTaxClassesToResult();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addRatesToResult');
        return $pluginInfo ? $this->___callPlugins('addRatesToResult', func_get_args(), $pluginInfo) : parent::addRatesToResult();
    }
    ...
    public function setClassTypeFilter($type, $id)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setClassTypeFilter', func_get_args(), $pluginInfo) : parent::setClassTypeFilter($type, $id);
    }
