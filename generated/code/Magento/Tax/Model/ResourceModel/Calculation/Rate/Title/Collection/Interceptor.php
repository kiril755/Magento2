...
class Interceptor extends \Magento\Tax\Model\ResourceModel\Calculation\Rate\Title\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'loadByRateId');
        return $pluginInfo ? $this->___callPlugins('loadByRateId', func_get_args(), $pluginInfo) : parent::loadByRateId($rateId);
    }
