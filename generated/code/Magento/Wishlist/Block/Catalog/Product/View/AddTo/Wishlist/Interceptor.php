...
class Interceptor extends \Magento\Wishlist\Block\Catalog\Product\View\AddTo\Wishlist implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWishlistOptionsJson');
        return $pluginInfo ? $this->___callPlugins('getWishlistOptionsJson', func_get_args(), $pluginInfo) : parent::getWishlistOptionsJson();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWishlistParams');
        return $pluginInfo ? $this->___callPlugins('getWishlistParams', func_get_args(), $pluginInfo) : parent::getWishlistParams();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isWishListAllowed');
        return $pluginInfo ? $this->___callPlugins('isWishListAllowed', func_get_args(), $pluginInfo) : parent::isWishListAllowed();
    }
