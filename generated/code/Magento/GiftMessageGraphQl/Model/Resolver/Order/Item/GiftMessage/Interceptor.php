...
class Interceptor extends \Magento\GiftMessageGraphQl\Model\Resolver\Order\Item\GiftMessage implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\GiftMessage\Api\OrderItemRepositoryInterface $itemRepository, \Magento\GiftMessage\Helper\Message $giftMessageHelper)
    {
        $this->___init();
        parent::__construct($itemRepository, $giftMessageHelper);
    }
