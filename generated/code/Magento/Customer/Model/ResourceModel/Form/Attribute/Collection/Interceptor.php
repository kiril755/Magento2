...
class Interceptor extends \Magento\Customer\Model\ResourceModel\Form\Attribute\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addFormCodeFilter($code)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addFormCodeFilter', func_get_args(), $pluginInfo) : parent::addFormCodeFilter($code);
    }
    ...
    public function setSortOrder($direction = 'ASC')
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setSortOrder', func_get_args(), $pluginInfo) : parent::setSortOrder($direction);
    }
