...
class Interceptor extends \Magento\Customer\Model\ResourceModel\Grid\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addFullTextFilter');
        return $pluginInfo ? $this->___callPlugins('addFullTextFilter', func_get_args(), $pluginInfo) : parent::addFullTextFilter($value);
    }
