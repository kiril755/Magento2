...
class Interceptor extends \Magento\Catalog\Block\Product\View\GalleryOptions implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getOptionsJson');
        return $pluginInfo ? $this->___callPlugins('getOptionsJson', func_get_args(), $pluginInfo) : parent::getOptionsJson();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFSOptionsJson');
        return $pluginInfo ? $this->___callPlugins('getFSOptionsJson', func_get_args(), $pluginInfo) : parent::getFSOptionsJson();
    }
