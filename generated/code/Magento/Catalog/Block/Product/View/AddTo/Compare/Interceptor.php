...
class Interceptor extends \Magento\Catalog\Block\Product\View\AddTo\Compare implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPostDataParams');
        return $pluginInfo ? $this->___callPlugins('getPostDataParams', func_get_args(), $pluginInfo) : parent::getPostDataParams();
    }
