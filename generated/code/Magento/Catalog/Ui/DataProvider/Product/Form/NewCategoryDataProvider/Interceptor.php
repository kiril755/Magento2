...
class Interceptor extends \Magento\Catalog\Ui\DataProvider\Product\Form\NewCategoryDataProvider implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct($name, $primaryFieldName, $requestFieldName, \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory $collectionFactory, \Magento\Framework\UrlInterface $urlBuilder, array $meta = [], array $data = [])
    {
        $this->___init();
