...
class Interceptor extends \Magento\Catalog\Model\ResourceModel\Product\Compare\Item\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setListId');
        return $pluginInfo ? $this->___callPlugins('setListId', func_get_args(), $pluginInfo) : parent::setListId($listId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getListId');
        return $pluginInfo ? $this->___callPlugins('getListId', func_get_args(), $pluginInfo) : parent::getListId();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductsByListId');
        return $pluginInfo ? $this->___callPlugins('getProductsByListId', func_get_args(), $pluginInfo) : parent::getProductsByListId($listId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setListIdToCustomerCompareItems');
        return $pluginInfo ? $this->___callPlugins('setListIdToCustomerCompareItems', func_get_args(), $pluginInfo) : parent::setListIdToCustomerCompareItems($listId, $customerId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'removeCompareList');
        return $pluginInfo ? $this->___callPlugins('removeCompareList', func_get_args(), $pluginInfo) : parent::removeCompareList($customerId);
    }
