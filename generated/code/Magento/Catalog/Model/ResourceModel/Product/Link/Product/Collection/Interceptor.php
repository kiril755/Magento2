...
class Interceptor extends \Magento\Catalog\Model\ResourceModel\Product\Link\Product\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function setLinkModel(\Magento\Catalog\Model\Product\Link $linkModel)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setLinkModel', func_get_args(), $pluginInfo) : parent::setLinkModel($linkModel);
    }
    ...
    public function setIsStrongMode()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setIsStrongMode', func_get_args(), $pluginInfo) : parent::setIsStrongMode();
    }
    ...
    public function getLinkModel()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getLinkModel', func_get_args(), $pluginInfo) : parent::getLinkModel();
    }
    ...
    public function addExcludeProductFilter($products)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addExcludeProductFilter', func_get_args(), $pluginInfo) : parent::addExcludeProductFilter($products);
    }
    ...
    public function addProductFilter($products)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addProductFilter', func_get_args(), $pluginInfo) : parent::addProductFilter($products);
    }
    ...
    public function setRandomOrder()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setRandomOrder', func_get_args(), $pluginInfo) : parent::setRandomOrder();
    }
    ...
    public function setGroupBy($groupBy = 'e.entity_id')
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setGroupBy', func_get_args(), $pluginInfo) : parent::setGroupBy($groupBy);
    }
    ...
    public function setAttributeSetIdOrder($dir = 'ASC')
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setAttributeSetIdOrder', func_get_args(), $pluginInfo) : parent::setAttributeSetIdOrder($dir);
    }
    ...
    public function joinAttributes()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('joinAttributes', func_get_args(), $pluginInfo) : parent::joinAttributes();
    }
    ...
    public function getLinkAttributes($type = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getLinkAttributes', func_get_args(), $pluginInfo) : parent::getLinkAttributes($type);
    }
    ...
    public function addLinkAttributeToFilter($code, $condition)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addLinkAttributeToFilter', func_get_args(), $pluginInfo) : parent::addLinkAttributeToFilter($code, $condition);
    }
