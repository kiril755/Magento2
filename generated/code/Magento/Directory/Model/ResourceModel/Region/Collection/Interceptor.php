...
class Interceptor extends \Magento\Directory\Model\ResourceModel\Region\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addAllowedCountriesFilter($store = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addAllowedCountriesFilter', func_get_args(), $pluginInfo) : parent::addAllowedCountriesFilter($store);
    }
    ...
    public function addCountryFilter($countryId)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addCountryFilter', func_get_args(), $pluginInfo) : parent::addCountryFilter($countryId);
    }
    ...
    public function addCountryCodeFilter($countryCode)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addCountryCodeFilter', func_get_args(), $pluginInfo) : parent::addCountryCodeFilter($countryCode);
    }
    ...
    public function addRegionCodeFilter($regionCode)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addRegionCodeFilter', func_get_args(), $pluginInfo) : parent::addRegionCodeFilter($regionCode);
    }
    ...
    public function addRegionNameFilter($regionName)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addRegionNameFilter', func_get_args(), $pluginInfo) : parent::addRegionNameFilter($regionName);
    }
    ...
    public function addRegionCodeOrNameFilter($region)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addRegionCodeOrNameFilter', func_get_args(), $pluginInfo) : parent::addRegionCodeOrNameFilter($region);
    }
