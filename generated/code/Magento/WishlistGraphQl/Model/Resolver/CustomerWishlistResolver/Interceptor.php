...
class Interceptor extends \Magento\WishlistGraphQl\Model\Resolver\CustomerWishlistResolver implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Wishlist\Model\WishlistFactory $wishlistFactory, \Magento\Wishlist\Model\Wishlist\Config $wishlistConfig)
    {
        $this->___init();
        parent::__construct($wishlistFactory, $wishlistConfig);
    }
