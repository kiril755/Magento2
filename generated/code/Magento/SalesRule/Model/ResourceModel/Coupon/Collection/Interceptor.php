...
class Interceptor extends \Magento\SalesRule\Model\ResourceModel\Coupon\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addRuleToFilter($rule)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addRuleToFilter', func_get_args(), $pluginInfo) : parent::addRuleToFilter($rule);
    }
    ...
    public function addRuleIdsToFilter(array $ruleIds)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addRuleIdsToFilter', func_get_args(), $pluginInfo) : parent::addRuleIdsToFilter($ruleIds);
    }
    ...
    public function addGeneratedCouponsFilter()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addGeneratedCouponsFilter', func_get_args(), $pluginInfo) : parent::addGeneratedCouponsFilter();
    }
    ...
    public function addIsUsedFilterCallback($collection, $column)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addIsUsedFilterCallback', func_get_args(), $pluginInfo) : parent::addIsUsedFilterCallback($collection, $column);
    }
