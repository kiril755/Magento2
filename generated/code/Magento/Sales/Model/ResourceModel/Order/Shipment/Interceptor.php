...
/**
 * Interceptor class for @see \Magento\Sales\Model\ResourceModel\Order\Shipment
 */
class Interceptor extends \Magento\Sales\Model\ResourceModel\Order\Shipment implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function saveAttribute(\Magento\Framework\Model\AbstractModel $object, $attribute)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('saveAttribute', func_get_args(), $pluginInfo) : parent::saveAttribute($object, $attribute);
    }
