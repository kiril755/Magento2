...
class Interceptor extends \Magento\Sales\Model\ResourceModel\Order\Shipment\Comment\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setShipmentFilter');
        return $pluginInfo ? $this->___callPlugins('setShipmentFilter', func_get_args(), $pluginInfo) : parent::setShipmentFilter($shipmentId);
    }
