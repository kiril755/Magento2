...
class Interceptor extends \Magento\Sales\Model\ResourceModel\Order\Invoice\Comment\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setInvoiceFilter');
        return $pluginInfo ? $this->___callPlugins('setInvoiceFilter', func_get_args(), $pluginInfo) : parent::setInvoiceFilter($invoiceId);
    }
