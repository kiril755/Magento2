...
class Interceptor extends \Magento\Sales\Model\ResourceModel\Order\Creditmemo\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFiltered');
        return $pluginInfo ? $this->___callPlugins('getFiltered', func_get_args(), $pluginInfo) : parent::getFiltered($filter);
    }
