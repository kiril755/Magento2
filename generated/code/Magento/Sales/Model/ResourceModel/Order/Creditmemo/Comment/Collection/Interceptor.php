...
class Interceptor extends \Magento\Sales\Model\ResourceModel\Order\Creditmemo\Comment\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setCreditmemoFilter');
        return $pluginInfo ? $this->___callPlugins('setCreditmemoFilter', func_get_args(), $pluginInfo) : parent::setCreditmemoFilter($creditmemoId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setParentFilter');
        return $pluginInfo ? $this->___callPlugins('setParentFilter', func_get_args(), $pluginInfo) : parent::setParentFilter($parent);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addVisibleOnFrontFilter');
        return $pluginInfo ? $this->___callPlugins('addVisibleOnFrontFilter', func_get_args(), $pluginInfo) : parent::addVisibleOnFrontFilter($flag);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setCreatedAtOrder');
        return $pluginInfo ? $this->___callPlugins('setCreatedAtOrder', func_get_args(), $pluginInfo) : parent::setCreatedAtOrder($direction);
    }
