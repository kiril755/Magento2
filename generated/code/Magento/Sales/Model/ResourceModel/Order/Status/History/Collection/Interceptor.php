...
class Interceptor extends \Magento\Sales\Model\ResourceModel\Order\Status\History\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getUnnotifiedForInstance');
        return $pluginInfo ? $this->___callPlugins('getUnnotifiedForInstance', func_get_args(), $pluginInfo) : parent::getUnnotifiedForInstance($instance);
    }
