...
class Interceptor extends \Magento\Sales\Model\ResourceModel\Order\Item\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addIdFilter($item)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addIdFilter', func_get_args(), $pluginInfo) : parent::addIdFilter($item);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'filterByTypes');
        return $pluginInfo ? $this->___callPlugins('filterByTypes', func_get_args(), $pluginInfo) : parent::filterByTypes($typeIds);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'filterByParent');
        return $pluginInfo ? $this->___callPlugins('filterByParent', func_get_args(), $pluginInfo) : parent::filterByParent($parentId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setSalesOrder');
        return $pluginInfo ? $this->___callPlugins('setSalesOrder', func_get_args(), $pluginInfo) : parent::setSalesOrder($order);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSalesOrder');
        return $pluginInfo ? $this->___callPlugins('getSalesOrder', func_get_args(), $pluginInfo) : parent::getSalesOrder();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setOrderFilter');
        return $pluginInfo ? $this->___callPlugins('setOrderFilter', func_get_args(), $pluginInfo) : parent::setOrderFilter($order);
    }
