...
class Interceptor extends \Magento\Downloadable\Model\ResourceModel\Link\Purchased\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addPurchasedItemsToResult');
        return $pluginInfo ? $this->___callPlugins('addPurchasedItemsToResult', func_get_args(), $pluginInfo) : parent::addPurchasedItemsToResult();
    }
