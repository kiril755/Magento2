...
class Interceptor extends \Magento\Downloadable\Model\Product\Type implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getLinks($product)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getLinks', func_get_args(), $pluginInfo) : parent::getLinks($product);
    }
    ...
    public function hasLinks($product)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('hasLinks', func_get_args(), $pluginInfo) : parent::hasLinks($product);
    }
    ...
    public function getLinkSelectionRequired($product)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getLinkSelectionRequired', func_get_args(), $pluginInfo) : parent::getLinkSelectionRequired($product);
    }
    ...
    public function getSamples($product)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getSamples', func_get_args(), $pluginInfo) : parent::getSamples($product);
    }
    ...
    public function hasSamples($product)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('hasSamples', func_get_args(), $pluginInfo) : parent::hasSamples($product);
    }
