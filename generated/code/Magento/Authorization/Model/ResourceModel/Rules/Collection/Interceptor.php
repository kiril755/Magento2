...
class Interceptor extends \Magento\Authorization\Model\ResourceModel\Rules\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getByRoles($roleId)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getByRoles', func_get_args(), $pluginInfo) : parent::getByRoles($roleId);
    }
    ...
    public function addSortByLength()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addSortByLength', func_get_args(), $pluginInfo) : parent::addSortByLength();
    }
