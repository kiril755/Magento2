...
class Interceptor extends \Magento\Authorization\Model\ResourceModel\Role\Grid\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function setUserFilter($userId, $userType)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setUserFilter', func_get_args(), $pluginInfo) : parent::setUserFilter($userId, $userType);
    }
    ...
    public function setRolesFilter()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setRolesFilter', func_get_args(), $pluginInfo) : parent::setRolesFilter();
    }
