...
class Interceptor extends \Magento\Newsletter\Model\ResourceModel\Subscriber\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'useQueue');
        return $pluginInfo ? $this->___callPlugins('useQueue', func_get_args(), $pluginInfo) : parent::useQueue($queue);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'useOnlyUnsent');
        return $pluginInfo ? $this->___callPlugins('useOnlyUnsent', func_get_args(), $pluginInfo) : parent::useOnlyUnsent();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'showCustomerInfo');
        return $pluginInfo ? $this->___callPlugins('showCustomerInfo', func_get_args(), $pluginInfo) : parent::showCustomerInfo();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addSubscriberTypeField');
        return $pluginInfo ? $this->___callPlugins('addSubscriberTypeField', func_get_args(), $pluginInfo) : parent::addSubscriberTypeField();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'showStoreInfo');
        return $pluginInfo ? $this->___callPlugins('showStoreInfo', func_get_args(), $pluginInfo) : parent::showStoreInfo();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'useOnlyCustomers');
        return $pluginInfo ? $this->___callPlugins('useOnlyCustomers', func_get_args(), $pluginInfo) : parent::useOnlyCustomers();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'useOnlySubscribed');
        return $pluginInfo ? $this->___callPlugins('useOnlySubscribed', func_get_args(), $pluginInfo) : parent::useOnlySubscribed();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getQueueJoinedFlag');
        return $pluginInfo ? $this->___callPlugins('getQueueJoinedFlag', func_get_args(), $pluginInfo) : parent::getQueueJoinedFlag();
    }
