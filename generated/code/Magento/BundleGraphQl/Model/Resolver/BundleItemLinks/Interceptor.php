...
class Interceptor extends \Magento\BundleGraphQl\Model\Resolver\BundleItemLinks implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\BundleGraphQl\Model\Resolver\Links\Collection $linkCollection, \Magento\Framework\GraphQl\Query\Resolver\ValueFactory $valueFactory)
    {
        $this->___init();
        parent::__construct($linkCollection, $valueFactory);
    }
