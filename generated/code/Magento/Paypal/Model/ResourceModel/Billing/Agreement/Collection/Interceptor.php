...
class Interceptor extends \Magento\Paypal\Model\ResourceModel\Billing\Agreement\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addCustomerDetails');
        return $pluginInfo ? $this->___callPlugins('addCustomerDetails', func_get_args(), $pluginInfo) : parent::addCustomerDetails();
    }
