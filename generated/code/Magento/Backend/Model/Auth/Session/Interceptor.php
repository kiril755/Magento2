...
class Interceptor extends \Magento\Backend\Model\Auth\Session implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAcl');
        return $pluginInfo ? $this->___callPlugins('getAcl', func_get_args(), $pluginInfo) : parent::getAcl();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setAcl');
        return $pluginInfo ? $this->___callPlugins('setAcl', func_get_args(), $pluginInfo) : parent::setAcl($acl);
    }
